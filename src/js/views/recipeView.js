    ...
    <div class="recipe__details">
      ...
      <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
          <button class="btn-tiny btn-decrease">
            <svg>
              <use href="img/sprite.svg#icon-circle-with-minus"></use>
            </svg>
          </button>
          <button class="btn-tiny btn-increase">
            <svg>
              <use href="img/sprite.svg#icon-circle-with-plus"></use>
            </svg>
          </button>
        </div>
      ...
      <button class="recipe__love">
        <svg class="header__likes">
          <use href="img/sprite.svg#icon-heart${isLiked ? '' : '-outlined'}"></use>
        </svg>
      </button>
    </div>
    ...
    <div class="recipe__ingredients">
      ...
      <button class="btn-small recipe__btn recipe__btn--add">
        <svg class="search__icon">
          <use href="img/sprite.svg#icon-shopping-cart"></use>
        </svg>
